...
public class Axe extends Hero{
   ...
   public Axe(String name,int hp, String type, Skill one,Skill two, Skill three){
   this.hp=hp;
   this.name=name;
   this.skill[0]=one;
   this.skill[1] = two;
   ...
   System.out.println("Axe attacked " + hero.getName() + " with "+skill.getSkillName()+ " and dealt "+skill.getDamage()+" damage.");
   }
